...
public class TechnicianAdapter$ViewHolder$$ViewBinder<T extends com.mindtree.fsmmindtree.view.TechnicianAdapter.ViewHolder> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131624241, "field 'txtTechnicianName'");
    target.txtTechnicianName = finder.castView(view, 2131624241, "field 'txtTechnicianName'");
    view = finder.findRequiredView(source, 2131624242, "field 'txtTechnicianSkill'");
    target.txtTechnicianSkill = finder.castView(view, 2131624242, "field 'txtTechnicianSkill'");
  }
